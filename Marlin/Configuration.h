...
#define STRING_CONFIG_H_AUTHOR "a6 mech, skr 1.4T, V1.0" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 50.17
    #define DEFAULT_Ki 9.22
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -10, -50, -1.5 }
